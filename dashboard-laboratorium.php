    ...
    <div id="page-wrapper">
  	...
  	<div class="row">
    	<div class="col-lg-12">
			...
			<audio id="suarabelabjad" src="rekaman/f.mp3"></audio>  
			<audio id="suarabelsuarabelloket" src="rekaman/ke-laboratorium.mp3">
			</audio>
	  	...
	  	<div id="page-wrapper">
	    	...
	    	<div align="center" class="panel panel-primary">
	            ...
	            <div class="bs-example">
	                ...
	                <font size="6">Laboratorium</font><br><br>
					<form method="post" action="add-laboratorium" role="form">
	    	...
	    	<div align="center" class="panel panel-primary">
	            ...
	            <div class="bs-example">
	                <font size="10">F<?php echo $tcounter; ?></font><br>
	                <font size="6">Laboratorium</font><br><br>
	            <form method="post" action="next-laboratorium" role="form">
	            	<a href="reset-laboratorium" name="reset" 
