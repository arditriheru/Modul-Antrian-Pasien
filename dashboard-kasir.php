    ...
    <div id="page-wrapper">
  	...
  	<div class="row">
    	<div class="col-lg-12">
			...
			<audio id="suarabelsuarabelloket" src="rekaman/ke-kasir.mp3">
			</audio>
	  	...
	  	<div id="page-wrapper">
	    	...
	    	<div align="center" class="panel panel-primary">
	            ...
	            <div class="bs-example">
	                ...
	                <font size="6">Kasir</font><br><br>
					<form method="post" action="add-kasir" role="form">
	    	...
	    	<div align="center" class="panel panel-primary">
	            ...
	            <div class="bs-example">
	                ...
	                <font size="6">Kasir</font><br><br>
	            <form method="post" action="next-kasir" role="form">
	            	<a href="reset-kasir" name="reset" 
