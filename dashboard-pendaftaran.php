    ...
    <div id="page-wrapper">
  	...
  	<div class="row">
    	<div class="col-lg-12">
			...
			<audio id="suarabelsuarabelloket" src="rekaman/ke-meja-pendaftaran.mp3">
			</audio>
	  	...
	  	<div id="page-wrapper">
	    	...
	    	<div align="center" class="panel panel-primary">
	            ...
	            <div class="bs-example">
	                ...
	                <font size="6">Pendaftaran</font><br><br>
					<form method="post" action="add-pendaftaran" role="form">
	    	...
	    	<div align="center" class="panel panel-primary">
	            ...
	            <div class="bs-example">
	                ...
	                <font size="6">Pendaftaran</font><br><br>
	            <form method="post" action="next-pendaftaran" role="form">
	            	<a href="reset-pendaftaran" name="reset" 
